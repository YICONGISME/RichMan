...
var Jewels = (function (_super) {
    ...
    Jewels.prototype.init = function () {
        if (this.type == JewelsType.COIN) {
            this.coin_mc = Common.getInstance().buildTypeMc("coin_json", "coin_png", "coin");
            ...
            this.shoe_shaped_mc = Common.getInstance().buildTypeMc("shoe-shaped_json", "shoe-shaped_png", "shoe-shaped");
            ...
            this.chest_mc = Common.getInstance().buildTypeMc("chest_json", "chest_png", "chest");
            ...
            this.bomb_mc = Common.getInstance().buildTypeMc("bomb_json", "bomb_png", "bomb");
